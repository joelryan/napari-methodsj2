...
def filterProperties1(filter1=wid_options[0][0],filter2=wid_options[1][0],filter3=wid_options[2][0],filter4=wid_options[3][0],Exposure_Time_ms='0',Light_source_intensity='0',Binning='1x1',Fluorophore='',isComplete: bool=False) -> ImageData:
    global complete1
...
@magicgui(
    ...
    isComplete={"widget_type": "CheckBox", "value": False, "name": "complete"})
#give a specific value shown
def filterProperties2(filter2=wid_options[1][0],filter3=wid_options[2][0],filter4=wid_options[3][0],Exposure_Time_ms='0',Light_source_intensity='0',Binning='1x1',Fluorophore='',isComplete: bool=False) -> ImageData:
    global complete2
...
@magicgui(
    ...
    isComplete={"widget_type": "CheckBox", "value": False, "name": "complete"})
#give a specific value shown
def filterProperties3(filter2=wid_options[1][0],filter3=wid_options[2][0],filter4=wid_options[3][0],Exposure_Time_ms='0',Light_source_intensity='0',Binning='1x1',Fluorophore='',isComplete: bool=False) -> ImageData:
    global complete3
...
@magicgui(
    ...
    isComplete={"widget_type": "CheckBox", "value": False, "name": "complete"})
#give a specific value shown
def filterProperties4(filter2=wid_options[1][0],filter3=wid_options[2][0],filter4=wid_options[3][0],Exposure_Time_ms='0',Light_source_intensity='0',Binning='1x1',Fluorophore='',isComplete: bool=False) -> ImageData:
    global complete4
...
@magicgui(
    ...
    isComplete={"widget_type": "CheckBox", "value": False, "name": "complete"})
#give a specific value shown
def filterProperties5(filter2=wid_options[1][0],filter3=wid_options[2][0],filter4=wid_options[3][0],Exposure_Time_ms='0',Light_source_intensity='0',Binning='1x1',Fluorophore='',isComplete: bool=False) -> ImageData:
    global complete5
